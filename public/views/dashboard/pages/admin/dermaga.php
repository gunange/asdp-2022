	...
	<div class="col-12 col-md-12">
		...
		<div class="page-header mt-4 mb-5">
			<div class="card card-small shadow-sm bx-shadow">
				<div class="card-body">
					<h5 class="text-secondary">Dermaga</h5>
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							<li class="breadcrumb-item">Management</li>
							<li class="breadcrumb-item"><a href="<?= $this->gLink ?>Dermaga">Dermaga</a></li>
						</ol>
					</nav>
				</div>
			</div>
								...
								<tr>
									...
									<td class="text-center" width="120px">
										<div class="btn-group" role="group">
											...
											<button type="button" class="btn btn-sm bg-red text-white" title="Hapus" onclick="openModalShow('#modal-center', '<?= $this->gLink ?>SetDermaga/del/<?= $k ?>')">
