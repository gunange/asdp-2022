		...
		<div class="modal-body">
			<div class="row">
				...
				<div class="col-md-12 mb-3">
					...
					<input class="form-control form-control-sm" type="text" placeholder="Nama Jenis Tangki" name="jenis_tanki" required autocomplete="off">
				</div>
	...
	<form class="modal-content" method="POST">
		...
		<div class="modal-body">
			<div class="row">
				<div class="col-md-12 mb-3">
					<label class="form-label">Jenis Tankgi</label>
					<input class="form-control form-control-sm" type="text" placeholder="Nama Jenis Tangki" name="jenis_tanki" required autocomplete="off" value="<?= $this->data['jenis_tanki'] ?>">
				</div>				
			</div>
		</div>
		<div class="modal-footer">
...
<?php elseif ($this->setPage == "del"): ?>
	...
	<form class="modal-content" method="POST">
		...
		<div class="modal-body">
			<p class="fs-6">Apakah anda akan menghapus data tanki <span class="text-red-400"><?= $this->data['jenis_tanki'] ?></span> ?</p>
