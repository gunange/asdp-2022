<?php if ($this->setPage == "filter-print") : ?>
	...
	<form class="modal-content data-form" method="POST" action="<?= $this->gLink ?>SetInvoiceAirTawar/postPdf">
		...
		<div class="modal-body p-0">
			<div class="row">
				<div class="col-md-12 p-0">
					<iframe width="100%" height="500px" frameborder="0" src="<?= $this->gLink ?>PdfInvoiceAirTawar/Recap/<?= $this->id_kapal ?>/<?= $this->id_dermaga ?>/<?= $this->tanggal_awal ?>/<?= $this->tanggal_akhir ?>"></iframe>
				</div>
			</div>
		</div>
		<div class="modal-footer">
